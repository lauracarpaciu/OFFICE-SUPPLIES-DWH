...
CREATE VIEW dbo.qty_subcategories
AS
SELECT SUM(FactSales.Quantity) as qty,DimSubCategory.Sub_CategoryName
FROM
FactSales
INNER JOIN
DimProduct
...
INNER JOIN
DimSubCategory
on DimProduct.SubcategoryKey=DimSubCategory.SubcategoryKey
GROUP BY DimSubCategory.Sub_CategoryName;
